      ...
      >
        <div className="container my-5">
          ...
          <div className="lead text-center">
            Help us improve our app by providing your valuable feedback. You
      ...
      <div className="container row d-flex justify-content-between">
        <div className="card card mb-3 col-md-5 p-0 border border-primary">
          <div className="card-header text-center bg-primary text-white">
            Samvaad.AI : Feedback Form 1
          </div>
          <div className="card-body d-flex flex-column justify-content-between">
            <div>
              <h5 className="card-title">Feedback on Overall App</h5>
              <p className="card-text">
                Tell us what you think about the overall app design. 
                Rate us on various metrics like satisfaction, appearance,
                usability etc.
              </p>
            </div>
            <div className='mt-3'>
